...
#[ORM\Entity(repositoryClass: InvoiceCustomerBillingAddressRepository::class)]
#[ORM\Table(name:"invoices_customers_billing_addresses")]
class InvoiceCustomerBillingAddress {
    ...
    #[ORM\OneToOne(targetEntity: InvoiceCustomer::class, inversedBy: "invoiceCustomerBillingAddress")]
